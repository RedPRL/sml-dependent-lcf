...
We can now encode \emph{PairIntro} as a single refinement rule,
$\DProdIntroRuleNullary$:

\[
  \Refine{\IsTrueUnmoded{\TyDProd{A}{x}{B}}}{\DProdIntroRuleNullary}{%
    \left\{\begin{array}{l}
        \SG{\alpha}{\IsTrueUnmoded{A}}\\
        \SG{\beta}{\IsTrueUnmoded{\Subst{\alpha}{x}{B}}}
    \end{array}\right.
  }{
    \Tuple{\alpha,\beta}
  }
...
$\ThenTac{\tau_1}{\tau_2}$ which accounts for this dependency.
